    ...
    <footer className="bg-gray-800 border-t border-gray-700 mt-20">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div>
            ...
            <p className="text-gray-400">
              Software Engineer from Brazil with 11 years of experience in Node.js, React, and React Native.
            </p>
          </div>
          ...
          {/* Social Links */}
          <div>
            <h3 className="text-lg font-bold mb-4 text-gray-100">Connect</h3>
            <div className="flex space-x-4">
              <a
                href="https://github.com/davisbento"
                target="_blank"
                rel="noopener noreferrer"
                className="p-2 rounded-lg bg-gray-700 hover:bg-primary hover:text-white transition-all"
                aria-label="GitHub"
              >
        ...
        <div className="mt-8 pt-8 border-t border-gray-700 text-center text-gray-400">
          <p>&copy; {currentYear} Davi Bento. All rights reserved.</p>
        </div>
      </div>
    </footer>
  );
